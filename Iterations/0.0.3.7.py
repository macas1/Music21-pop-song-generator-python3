#Bradley McInerney 29/10/2016
#Ver 0.0.1.7
#test3 > Has a chorus/verse/chorus structure with different secton specs
...
chordInfo1  = change_doubleDurations(composeChords(songSpecs1, section2Specs)) * 4
melodyInfo1 = composeMelody(songSpecs1, section1Specs)
melodyInfo1 = (melodyInfo1 + change_invert(melodyInfo1, choice([1, 4])) + melodyInfo1 + composeMelody(songSpecs1, section1Specs))*2
melodyInfo1 = alignMelody(melodyInfo1, chordInfo1)
melodyInfo1 = debug_unison(melodyInfo1)

chordInfo2  = change_doubleDurations(composeChords(songSpecs1, section2Specs)) * 4
melodyInfo2 = composeMelody(songSpecs1, section1Specs)
melodyInfo2 = (melodyInfo2 + change_invert(melodyInfo2, choice([1, 4])) + melodyInfo2 + composeMelody(songSpecs1, section1Specs))*2
...
noteListToStream(melodyStream, songSpecs1, [[4], melodyInfo2], compression)
noteListToStream(melodyStream, songSpecs1, [[4], melodyInfo1], compression)

chordStream = stream.Stream()
noteListToStream(chordStream, songSpecs1, [[3], chordInfo1], compression)
noteListToStream(chordStream, songSpecs1, [[3], chordInfo2], compression)
noteListToStream(chordStream, songSpecs1, [[3], chordInfo1], compression)
