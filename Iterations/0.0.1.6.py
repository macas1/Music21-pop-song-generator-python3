...
chordChance = [2, 95, 5, 98, 98, 98, [2, 2], [2, 4], [2, 4], [5, 30]]

#number of groups, number of bars per group, chances
section2Specs = [4, chordChance]

melodyInfo1 = composeMelody(songSpecs, section1Specs)
melodyInfo2 = changeMelody_KeepStructure(melodyInfo1, section1Specs)
melodyInfo = melodyInfo1 + melodyInfo2 + melodyInfo1 + composeMelody(songSpecs, section1Specs)
chordInfo = change_doubleDurations(composeChords(songSpecs, section2Specs)) * 2

#output and repeat 3 times for testing
print(chordInfo)
print("-----------------------")
print(melodyInfo)
print("-----------------------")
